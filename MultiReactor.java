...
/**
 * 为了匹配 CPU 和 IO 的速率，可设计多个 Reactor（即 Selector 池）：<p> 主 Reacotr 负责监听连接，然后将连接注册到从 Reactor，将 I/O
 * 转移了<br> 从 Reacotr 负责通道 I/O 的读写，处理器可选择单线程或线程池
 * <p>
